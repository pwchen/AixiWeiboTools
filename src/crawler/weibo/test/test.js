!window.register_login_index
		&& function() {
			...
			if (!STK)
				var STK = function() {
					...
					a[b] = {
						...
						E : function(a) {
							return typeof a == "string" ? document
									.getElementById(a) : a
						},
						C : function(a) {
							var b;
							...
							function(a) {
								...
								return {
									addAlgorithm : function(a, c) {
										if (b[a])
											throw "[core.ani.tweenValue] this algorithm :"
													+ a + "already exist";
										b[a] = c
									},
			...
			STK.register("core.ani.tweenArche", function(a) {
				return function(b, c) {
					...
					var l = function() {
						f = +(new Date) - g;
						if (f < d.duration) {
							h = a.core.ani.algorithm.compute(d.animationType,
									0, d.distance, f, d.duration, d.extra,
									d.algorithmParams);
							b(h);
							...
							function(a) {
								...
								return function(a, c) {
									...
									case "float":
										c = "styleFloat";
									default:
										var g = a.currentStyle ? a.currentStyle[c]
												: null;
										return a.style[c] || g
									}
								}
							...
							function(a) {
								var b = function(a) {
									...
									gecko : "-moz-"
										...
										"animation-timing-function" ], f = function(
										a) {
			...
			STK.register("core.dom.isNode", function(a) {
				return function(a) {
					return a != undefined && Boolean(a.nodeName)
							&& Boolean(a.nodeType)
				}
			});
			STK.register("core.json.merge", function(a) {
				var b = function(b) {
					return b === undefined ? !0 : b === null ? !0 : a.core.arr
							.inArray(typeof b, [ "number", "string",
									...
									opacity : function(a, b, c, d) {
										...
										return {
											filter : "alpha(opacity=" + e * 100
													+ ")",
											opacity : Math.max(Math.min(1, e),
													0),
											zoom : "1"
										}
									},
									defaultColor : function(a, b, c, d, e) {
										var f = Math.max(0, Math.min(255, Math
												.ceil(a * (c.getR() - b.getR())
														+ b.getR()))), g = Math
												.max(
														0,
														Math
							...
							function(a) {
								var b = function() {
									...
									d.addRule = function(a, b) {
										...
										c.addRule ? c.addRule(a, b, d.length)
												: c.insertRule
														&& c
																.insertRule(
																		a
								...
								return function(c, d) {
									...
									a.core.evt.addEvent(c, "transitionend",
											function() {
												a.core.evt.removeEvent(c,
														"transitionend",
														arguments.callee);
												c.style.cssText = g.remove(
														"transition").getCss();
												a.core.dom
														.removeClassName(c, h);
												i.destory();
							...
							function(a) {
								return function(b) {
									...
									for ( var d = 0, e = b.length; d < e; d += 1)
										a.core.arr.findout([ undefined, null,
												"" ], b[d]).length
												|| c.push(b[d]);
									return c
								}
										...
										j.find.ID = function(a, b, c) {
											if (typeof b.getElementById != "undefined"
												...
												return d ? d.id === a[1]
														...
														&& d
																.getAttributeNode("id").nodeValue === a[1] ? [ d ]
														: undefined
														: []
											}
										};
								...
								document.querySelectorAll
										&& function() {
											...
											if (!b.querySelectorAll
													|| b
															.querySelectorAll(".TEST").length !== 0) {
												i = function(b, c, d, e) {
													c = c || document;
													if (!e && c.nodeType === 9
															&& !i.isXML(c))
			...
			STK
					.register("core.dom.setXY",
							function(a) {
								return function(b, c) {
									var d = a.core.dom.getStyle(b, "position");
									if (d == "static") {
										a.core.dom.setStyle(b, "position",
												"relative");
										d = "relative"
									}
									...
									if (e != !1) {
										var f = {
											l : parseInt(a.core.dom.getStyle(b,
													"left"), 10),
											t : parseInt(a.core.dom.getStyle(b,
													"top"), 10)
										};
										isNaN(f.l)
												&& (f.l = d == "relative" ? 0
			...
			STK.register("core.dom.cascadeNode", function(a) {
				return function(b) {
					...
					c.setText = function(d) {
						d !== undefined
								&& (b.innerHTML = a.core.str.encodeHTML(d));
						return c
					};
					c.getText = function() {
						return a.core.str.decodeHTML(b.innerHTML)
			...
			STK.register("core.dom.insertElement", function(a) {
				return function(b, c, d) {
					...
					case "beforeend":
						...
						break;
					case "afterend":
						b.nextSibling ? b.parentNode.insertBefore(c,
								b.nextSibling) : b.parentNode.appendChild(c)
					}
				}
			});
			STK
			...
			STK.register("core.dom.toggleClassName", function(a) {
				return function(b, c) {
					a.core.dom.hasClassName(b, c) ? a.core.dom.removeClassName(
							b, c) : a.core.dom.addClassName(b, c)
				}
			});
			...
			STK
					.register(
							...
							function(a) {
								return function(b, c) {
									var d = a.core.str.trim(b).split("&"), e = {}, f = function(
											a) {
			...
			STK
					.register(
							"core.evt.fixEvent",
							function(a) {
								var b = "clientX clientY pageX pageY screenX screenY"
										.split(" ");
								return function(b) {
									...
									!b.which
											&& b.button
											&& (b.button & 1 ? b.which = 1
													: b.button & 4 ? b.which = 2
															: b.button
																	& 2
																	&& (b.which = 3));
			...
			STK.register("core.func.methodBefore", function(a) {
				return function() {
					...
					d.add = function(d, e) {
						...
						f.top == !0 ? c.unshift([ d, f.args, f.pointer ]) : c
								.push([ d, f.args, f.pointer ]);
						return !b
					};
					d.start = function() {
						var a, d, e, f, g;
					...
					.register(
							...
							function(a) {
								...
								return function(c, d) {
									...
									var e = c.concat(), f = a.core.obj
											.parseParam(b, d), g = null, h = function() {
										var a = +(new Date);
										do
											f.process
													.call(f.context, e.shift());
										while (e.length > 0
												&& +(new Date) - a < f.execTime);
										e.length <= 0 ? f.callback
												&& f.callback(c) : setTimeout(
												arguments.callee, f.delay)
									};
							...
							function(a) {
								return function(b, c) {
									...
									e.valueOf = e.toString = function() {
										var b = [], c = a.core.json
												.jsonToQuery(g, d.isEncodeQuery), e = a.core.json
							...
							function($) {
								return function(oOpts) {
									...
									if (opts.method.toLocaleLowerCase() == "get") {
										...
										trans.send($.core.json.jsonToQuery(
												opts.args, opts.isEncode))
									}
									opts.timeout
			...
			STK.register("core.json.compare", function(a) {
				return function(b, c) {
					return a.core.json.include(b, c)
							&& a.core.json.include(c, b) ? !0 : !1
				}
			});
			STK
					.register(
			...
			STK.register("core.str.leftB", function(a) {
				return function(b, c) {
					var d = b.replace(/\*/g, " ")
							.replace(/[^\x00-\xff]/g, "**");
					b = b.slice(0, d.slice(0, c).replace(/\*\*/g, " ").replace(
							/\*/g, "").length);
				...
				return function(d, e) {
					...
					var f = a.core.obj.parseParam({
						...
						actObj : {}
							...
							"dragStart"), i = a.core.evt.custEvent.define(
							f.actObj, "dragEnd"), j = a.core.evt.custEvent
							.define(f.actObj, "draging"), k = function(d) {
						var e = c({}, d);
					...
					.register(
							...
							function(a) {
								return function(b, c) {
									...
									var h = Math.max(0, (f ? f.t : 0)
											- (g ? g.t : 0) - d.top), i = d.box === document.documentElement ? d.box.scrollTop
											|| document.body.scrollTop
											|| window.pageYOffset
											: d.box.scrollTop;
									while (Math.abs(i - h) > d.step && i !== 0) {
										e.push(Math.round(i + (h - i) * d.step
												/ 10));
										i = e[e.length - 1]
									}
									e.length || e.push(h);
									var j = a.core.util.timer
											.add(function() {
												if (e.length)
			...
			STK.register("common.channel.sso",
					function(a) {
						var b = [ "login", "logout", "verify.extra",
								"verify.username", "pincode", "pincode.create",
								"login.complete", "login.success",
								"login.failure", "logout.complete",
								"logout.success", "logout.failure",
								"verify.update", "verify.failure",
								"verify.complete", "pincode.update" ];
						return a.common.listener
								.define("common.channel.sso", b)
					});
			function SSOController() {
				var a = this, b = null, c = 1800, d = 86400, e = null, f = null, g = 3, h = null, i = "http://login.sina.com.cn/sso/crossdomain.php", j = "http://login.sina.com.cn/sso/login.php", k = "http://login.sina.com.cn/sso/logout.php", l = "http://login.sina.com.cn/sso/updatetgt.php", m = "http://login.sina.com.cn/sso/prelogin.php", n = "http://login.sina.com.cn/bindmail/checkmailuser.php", o = "http://login.sina.com.cn/cgi/pin.php", p = "http://weibo.com/sguide/vdun.php", q = null, r = "", s = {}, t = "check_alt_login", u = null, v = null, w = null, x = null, y = 1, z = 2, A = 4, B = "", C = {}, D = 0, E = 0, F;
				this.https = 1;
				this.rsa = 2;
				this.wsse = 4;
				...
				this.init = function() {
					...
					a.isUpdateCookieOnLoad
							&& setTimeout(a.name + ".updateCookie()", 1e4);
					a.isCheckLoginState && M(window, "load", function() {
						a.checkLoginState()
					});
					a.allowAutoFoundServerTime && ssoLoginServerTime
							&& a.setServerTime(ssoLoginServerTime);
					a.customInit()
				};
				...
				(function() {
					...
					this.callbackLoginStatus = function(b) {
						...
						i(f, "onComplete", b);
						b && b.result === !0 ? i(f, "onSuccess", b) : i(f,
								"onFailure", b)
					};
					F = function(b) {
						a.customLogoutCallBack(b);
						i(g, "onComplete", b);
						b && b.result === !0 ? i(g, "onSuccess", b) : i(g,
								"onFailure", b)
					};
					H = function(b) {
						var d;
						...
						for (d in f)
							c.hasOwnProperty(d) || (a[d] = f[d]);
						a.loginExtraQuery = {};
						for (d in e)
							f[d] && (a.loginExtraQuery[e[d]] = f[d])
					};
					G = function(b) {
						b = b || {};
						H(b);
					...
					w = function() {
						if (a.useIframe && (a.setDomain || a.feedBackUrl)) {
							if (a.setDomain) {
								...
								!a.feedBackUrl
										&& a.domain != "sina.com.cn"
										&& (a.feedBackUrl = $(
												a.appLoginURL[a.domain], {
													domain : 1
												}))
							}
							r = "post";
							...
							if (!e) {
								r = "get";
								a.scriptLoginHttps ? a.setLoginType(a.loginType
										| y) : a.setLoginType(a.loginType | z);
								R(b, c, d)
							}
						} else {
							r = "get";
				...
				this.prelogin = function(b, c) {
					var d = location.protocol == "https:" ? m.replace(/^http:/,
							"https:") : m, e = b.username || "";
				...
				this.logout = function() {
					try {
						...
						}, c = location.protocol == "https:" ? k.replace(
								/^http:/, "https:") : k;
						c = $(c, b);
						O(a.scriptId, c)
					} catch (d) {
				...
				this.updateCookie = function() {
					try {
						if (a.autoUpdateCookieTime > 5) {
							...
							b = setTimeout(a.name + ".updateCookie()",
									a.autoUpdateCookieTime * 1e3)
						}
						var e = a.getCookieExpireTime(), f = (new Date)
								.getTime() / 1e3, g = {};
						e == null ? g = {
							retcode : 6102
						} : e < f ? g = {
						...
						var h = location.protocol == "https:" ? l.replace(
								/^http:/, "https:") : l;
						h = $(h, {
							entry : a.getEntry(),
				...
				this.checkAltLoginNameCallback = function(a) {
					...
					if (a.ret == "y") {
						b.retcode = 1;
						b.detail = '为了您的账号安全，请<a href="http://login.sina.com.cn/bindmail/signin.php?username='
								+ s.username + '">绑定邮箱</a>';
						b.data = s.username
						...
						if (a.errcode == "not_verify") {
							...
							b.detail = "您的邮箱: "
									+ a.mail
									+ ' 未验证，点此<a href="http://login.sina.com.cn/bindmail/bindmail1.php?entry=sso&user='
									+ a.mail + '">重发验证邮件</a>';
							b.data = a.mail
						} else {
							b.retcode = 3;
				...
				this.loginCallBack = function(b) {
					try {
						if (a.timeoutEnable && !v.isset())
							return;
						v.clear();
						a.loginExtraFlag = {};
						var c = {}, d = b.ticket, e = b.uid;
						if (e) {
							c.result = !0;
							c.retcode = 0;
							c.userinfo = {
							...
							d && (c.ticket = d);
							if (a.feedBackUrl)
								a.crossDomain ? a.crossDomainAction("login",
										function() {
											a.callFeedBackUrl(c)
										}) : a.callFeedBackUrl(c);
							else if (a.crossDomain) {
								b.crossDomainUrlList
										&& a.setCrossDomainUrlList({
											retcode : 0,
											arrURL : b.crossDomainUrlList
										});
								a.crossDomainAction("login", function() {
									if (d && a.appLoginURL[a.domain])
										a.appLogin(d, a.domain, a.name
												+ ".callbackLoginStatus");
									else {
										c.userinfo = be(c.userinfo, a
												.getSinaCookie());
							...
							if (x && b.retcode == "2092"
									&& a.allowAutoFoundServerTimeError) {
								a.setServerTime(0);
				...
				this.getSinaCookie = function(a) {
					...
					if (!b)
						return null;
					var c = bd(b);
					return a && c.et && c.et * 1e3 < (new Date).getTime() ? null
							: c
				};
				...
				this.autoLogin = function(b) {
					if (a.domain == "sina.com.cn") {
						if (Z("SUP") === null && Z("ALF") !== null) {
							...
							&& (Z("SSOLoginState") !== null || Z("ALF") !== null)) {
						K(b);
						return !0
					}
					b(a.getSinaCookie());
				...
				this.appLogin = function(b, c, d) {
					var e = C.savestate ? parseInt((new Date).getTime() / 1e3
							+ C.savestate * 86400) : 0, f = Z("ALF") ? Z("ALF")
							: 0, g = {
						callback : d,
						ticket : b,
						ssosavestate : e || f
					}, h = a.appLoginURL[c], i = $(h, g);
				...
				this.autoLoginCallBack3 = function(b) {
					...
					a.appLogin(b.ticket, a.domain, a.name
							+ ".autoLoginCallBack2");
					return !0
				};
				...
				this.getPinCodeUrl = function(b) {
					...
					var c = location.protocol == "https:" ? o.replace(/^http:/,
							"https:") : o;
					return c + "?r=" + Math.floor(Math.random() * 1e8) + "&s="
							+ b + (B.length > 0 ? "&p=" + B : "")
				};
				...
				var J = function(a) {
					...
					for ( var d = 0; d < a; d++)
						c += b
								.charAt(Math.ceil(Math.random() * 1e6)
										% b.length);
					return c
				}, K = function(b) {
					h = b;
					...
					var d = location.protocol == "https:" ? j.replace(/^http:/,
							"https:") : j;
					d = $(d, c);
					...
					V(b);
					var e = document.getElementsByTagName("head")[0], f = document
					...
					V(b);
					var d = document.getElementsByTagName("body")[0], e = document
					...
					if (a.loginType & z && a.servertime && sinaSSOEncoder
						...
						c = f.encrypt([ a.servertime, a.nonce ].join("\t")
								+ "\n" + c)
					} else if (a.loginType & A && a.servertime
							&& sinaSSOEncoder && sinaSSOEncoder.hex_sha1) {
						e.servertime = a.servertime;
						e.nonce = a.nonce;
						e.pwencode = "wsse";
						c = sinaSSOEncoder.hex_sha1(""
								+ sinaSSOEncoder.hex_sha1(sinaSSOEncoder
										.hex_sha1(c)) + a.servertime + a.nonce)
					}
					e.sp = c;
					return e
				}, R = function(b, c, d) {
					...
					T(a.loginFrameName);
					var e = U(a.loginFormId), f = Q(b, c, d);
					f.encoding = "UTF-8";
					...
					for ( var g in a.loginExtraQuery) {
						if (typeof a.loginExtraQuery[g] == "function")
							continue;
					...
					return typeof a == "undefined" ? "undefined"
							: a === null ? "null" : Object.prototype.toString
									.call(a).replace(/^\[object\s|\]$/gi, "")
									.toLowerCase()
				}, X = function() {
			...
			STK
					.register(
							"pl.plugin.sso.source.main",
							function(a) {
								var b = window.sinaSSOController, c = a.common.channel.sso, d = {
									savestate : 0,
									vsnf : 0,
									hold_login_state : !1,
									cookie_timeout : 0,
								...
								return function(g) {
									var h = {
										...
										setExtra : function(c) {
											...
											d.cookie_timeout
													&& (c.ct = conf.cookie_timeout);
											d.hold_login_state && (c.s = 1);
											c.vsnf = d.vsnf;
											b.loginExtraQuery = a.core.json
													.merge(b.loginExtraQuery, c)
										},
										...
										bind : function() {
											...
											c.register("verify.username",
													i.verify.username);
											c.register("pincode.create",
													i.getUniqueKey);
											c.register("pincode",
													i.getPincodeUrl)
										},
			...
			STK.pageletM.register("pl.plugin.sso.index", function(a) {
				return a.pl.plugin.sso.source.main({
					...
					useTicket : !0,
					crossDomain : !0,
					feedBackUrl : "http://" + window.location.hostname
							+ "/ajaxlogin.php"
				})
			});
			STK.register("kit.extra.jsPath", function(a) {
				var b = {
					...
					if (typeof b.mPath != "undefined") {
						!c && d();
						return b.mPath[0].replace("{n}", c[Math.ceil(Math
								.random() * 10)
								% c.length])
					}
					return b.path
			...
			STK
					.register(
							"pl.plugin.wbad.source.main",
							function(a) {
								return function() {
									var b = a
											.sizzle("[ad-data]", document.body);
									if (b.length != 0) {
										var c = !1, d = document, e = d
												.createElement("script"), f = d
										...
										e.src = a.kit.extra
												...
												.replace(
														...
														"https:" == d.location.protocol ? "https://"
																: "http://")
												.replace("t5", "t4")
												+ "apps/publicity/static/wbad.js?version="
												+ $CONFIG.version;
			...
			STK.pageletM.register("pl.plugin.wbad.index", function(a) {
				...
				if (a.pageletView) {
					if (!b) {
						...
						a.custEvent.add(a.pageletView, "allPlRendReady",
								function() {
									c()
								})
					}
			...
			STK
					.register(
							"pl.plugin.suda.source.main",
							function(a) {
								window.SUDA = window.SUDA || [];
								Math.ceil(Math.random() * 1e4) == 1
										&& SUDA.push([ "setPerformance", 15 ]);
								SUDA
										.push([ "setGatherInfo", null,
												"WEIBO-V5" ]);
								return function() {
									var a = !1, b = document, c = b
											.createElement("script"), d = b
											.getElementsByTagName("script")[0];
									c.type = "text/javascript";
									c.charset = "utf-8";
									c.async = !0;
									c.src = ("https:" == b.location.protocol ? "https://"
											: "http://")
											+ "js.t.sinajs.cn/open/analytics/js/suda.js?version="
											+ $CONFIG.version;
					...
					.register(
							...
							function(a) {
								return function(b, c, d) {
									...
									i = e.pos.split("-");
									i[0] === "left" ? b.style.left = g.l
											+ e.offsetX + "px"
											: i[0] === "right" ? b.style.left = g.l
													+ h.w + e.offsetX + "px"
													: i[0] === "center"
															&& (b.style.left = g.l
																	+ h.w
																	...
																	+ e.offsetX
																	+ "px");
									i[1] === "top" ? b.style.top = g.t
											+ e.offsetY + "px"
											: i[1] === "bottom" ? b.style.top = g.t
													+ h.h + e.offsetY + "px"
													: i[1] === "middle"
															&& (b.style.top = g.t
																	+ h.h
			...
			STK.register("kit.extra.textareaUtils", function(a) {
				...
				b.replaceText = function(a, d) {
					...
					if (f.length == 0)
						...
						if (!c) {
							var j = h + f.length;
							a.value = e.slice(0, h) + d
									+ e.slice(h + g, e.length);
				...
				b.getSelectedText = function(a) {
					var b = "", d = function(a) {
						return a.selectionStart != undefined
								&& a.selectionEnd != undefined ? a.value
					...
					.register(
							...
							function(a) {
								...
								return function(d) {
									...
									i.text = function(b) {
										b !== undefined
												&& (g.innerHTML = a.core.str
														.encodeHTML(b));
										return a.core.str
												.decodeHTML(g.innerHTML)
									};
							...
							function(a) {
								...
								return function(c) {
									var d = {}, e, f, g, h, i = {
										...
										show : function(b, c, d) {
											var e = a.core.dom.getSize(c), h = Math
													.max(e.height, a.getStyle(
															c, "height")
															.replace("px", ""));
											d = a.parseParam({
												offsetX : 0,
							...
							function(a) {
								...
								return function(i, j) {
									var k, l, m, n, o, p, q, r = !1, s = {
										...
										build : function() {
											var b = a
													.builder(c(k.template.panel));
											l = b.list.layer[0];
											m = b.list.panel[0];
											document.body.appendChild(b.box)
										},
										show : function() {
											var b = a.core.dom.position(i), c = a.core.dom
													.getSize(i), d = [
													"position:absolute",
													...
													"left:" + (b.l + k.offsetX)
															+ "px",
													"top:"
															+ (b.t + c.height + k.offsetY)
															+ "px" ];
											if (k.width > 0) {
												d.push("width:" + k.width
														+ "px");
										...
										show : function() {
											q = s.get(i.value);
											var a = i.value.split("@"), b = a[0], c = a[1];
											k.autoTrim
													&& (b = b.replace(/^\s+/g,
															""));
											if (q
							...
							function(a) {
								...
								c.isEmail = function(a) {
									...
									if (a && a != "" && a.indexOf("@") != -1) {
										var b = a.indexOf("@"), c = a
												.substring(0, b);
										return c.length > 64 || a.length > 256 ? !1
												: !0
									}
									return !1
								};
								c.isEmailName = function(a) {
									return /^[0-9a-z_][_.0-9a-z-]{0,31}$/
											.test(a)
								};
								...
								c.isWeakPasswd = function(b) {
									var d = [ "000000", "111111", "11111111",
											"112233", "123123", "123321",
											"123456", "12345678", "654321",
											"666666", "888888", "abcdef",
											"abcabc", "abc123", "a1b2c3",
											"aaa111", "123qwe", "qwerty",
											"qweasd", "admin", "password",
											"p@ssword", "passwd", "iloveyou",
											"5201314" ];
									if (a.inArray(b, d))
										return !0;
								...
								c.isMobileSea = function(a, b) {
									...
									case "0082":
										return /^(010|011|016|017|018|019|070)(\d{7}|\d{8})$/
												.test(a);
									case "00850":
										return /^\d{10}$/.test(a);
									case "0065":
									...
									case "0033":
										return /^((6\d{8})|(7[345678]\d{7}))$/
												.test(a);
									case "007":
										return /^((90[12345689]\d{7})|(9[123]\d{8})|(95[0123]\d{7}))$/
												.test(a);
									case "0091":
			...
			STK.register("common.setting.form", function(a) {
				var b = [ "input", "textarea", "select", "a", "div", "ul",
						"li", "em" ];
				return function(c, d) {
					var e = {}, f, g = "form", h = {
						ctls : {},
						...
						check : function(a) {
							...
							for ( var d in h.ctls) {
								var b = h.ctls[d];
								b.pars.iorecords ? h.states[d] = b.msg
										: h.states[d] = b.check();
			...
			STK.register("common.setting.base", function(a) {
				return function() {
					var b = {};
					b.frame = [ "id", "preInit", "init", "initPars", "build",
							"bind", "errText", "setMust", "setMsg", "disabled",
							"check", "name", "value", "reset", "fire",
							"destroy" ];
				...
				return function(b, c, d) {
					...
					e.build = function() {
						e.rule.isEmpty(b.defaultValue)
								&& (e.pars.text ? b.value = e.pars.text
										: b.value = "");
					...
					e.fire = function() {
						e.errText[e.msg.code]
								&& (e.msg.msg = e.errText[e.msg.code]);
						var b = {};
						b[e.type] = e.msg;
						e.pars.hook
								&& a.custEvent.fire(e.pars.hook, "check", b)
					};
					...
					e.value = function(a) {
						if (typeof a != "undefined")
							...
							return b.value === e.pars.text ? "" : b.value
									.replace(/^\s+|\s+$/g, "")
					};
					e.reset = function(b) {
						e.value(e.old_value);
			...
			STK.register("common.setting.verifycode", function(a) {
				...
				return function(b, d) {
					...
					}, g = a.common.setting.control(b, d, {
						evtAct : f,
						check : e
			...
			STK.register("common.setting.username", function(a) {
				...
				return function(b, d) {
					...
					}, g = {}, h = a.common.setting.control(b, d, {
						evtAct : g,
						check : f
			...
			STK.register("common.setting.passwordlite", function(a) {
				...
				return function(b, e) {
					var f = function() {
						...
						blur : function() {
							d && clearTimeout(d);
							b.value = j.rule.reNullChar(b.value);
							j.msg.action = "blur";
							f();
							j.fire();
							h.auto()
						}
					}, j = a.common.setting.control(b, e, {
						evtAct : i,
						check : f
			...
			STK
					.register(
							"common.login.form",
							function(a) {
								var b = [ "username", "password", "verifycode",
										"vsncode" ], c = a.core.util.templet, d = a.common.channel.sso, e = a.common.form.verifycodeSSO, f = a.core.evt.hotKey, g = a.kit.extra.textareaUtils, h = {
								...
								return function(f, l) {
									var n, o, p, q, r = {}, s, t, u, v, w = {
										...
										bind : function() {
											...
											n.add("btn_submit", "click",
													x.submit.active);
											n.add("btn_change_verifycode",
													"click", x.resetVerifycode);
											a.addEvent(p.username, "focus",
													x.stopCheckUsername);
											a.addEvent(p.username, "blur",
													x.checkUsername);
											a.addEvent(p.submitBtn, "focus",
													x.submit.focus);
											a.addEvent(p.submitBtn, "blur",
													x.submit.blur);
											...
											a.addEvent(p.submitBtn, "keydown",
													y.enter);
											a.addEvent(p.password, "keypress",
													y.capslock);
											d.register("verify.update",
													z.verify.update);
											d.register("verify.failure",
													z.verify.failure);
											d.register("verify.complete",
													z.verify.complete);
											d.register("login.success",
													z.login.success);
											d.register("login.failure",
													z.login.failure);
											d.register("login.complete",
													z.login.complete);
											d.register("logout.success",
													z.logout.success);
											d.register("logout.failure",
													z.logout.failure);
											d.register("logout.complete",
													z.logout.complete)
										},
										unbind : function() {
											n.remove("btn_submit", "click",
													x.submit.active);
											n.remove("btn_change_verifycode",
													"click", x.resetVerifycode);
											n.destroy();
											a.removeEvent(p.username, "focus",
													x.stopCheckUsername);
											a.removeEvent(p.username, "blur",
													x.checkUsername);
											a.removeEvent(p.submitBtn, "focus",
													x.submit.focus);
											a.removeEvent(p.submitBtn, "blur",
													x.submit.blur);
											a.foreach(o.ctls, function(b) {
												a.removeEvent(b.node,
														"keydown", y.enter)
											});
											a.removeEvent(p.submitBtn,
													"keydown", y.enter);
											a.removeEvent(p.password,
													"keypress", y.capslock);
											d.remove("verify.update",
													z.verify.update);
											d.remove("verify.failure",
													z.verify.failure);
											d.remove("verify.complete",
													z.verify.complete);
											d.remove("login.success",
													z.login.success);
											d.remove("login.failure",
													z.login.failure);
											d.remove("login.complete",
													z.login.complete);
											d.remove("logout.success",
													z.logout.success);
											d.remove("logout.failure",
													z.logout.failure);
											d.remove("logout.complete",
													z.logout.complete)
										},
										destroy : function() {
											w.unbind();
										...
										init : function() {
											...
											a.custEvent.define(q, [ "focus",
													"blur", "keyup" ]);
											a.custEvent.add(q, "focus",
													x.textCopyHandle);
											a.custEvent.add(q, "blur",
													x.textCopyHandle);
											...
											var e = a.core.dom
													.getSize(p.username.parentNode).width;
											t = a.common.layer
													.emailAutocomplete(
															p.username, {
																autoTrim : !0,
											...
											A.vsncode.disable();
											s = a.common.extra
													.inputMonitor(p.username);
											a.custEvent.add(s, "change",
													function() {
														x.changeExtra();
														j.reset()
													});
										...
										checkUsername : function() {
											a.preventDefault();
											r.checkUsername
													&& clearTimeout(r.checkUsername);
											r.checkUsername = setTimeout(
													function() {
										...
										errTip : {
											handle : function(b, c) {
												...
												var d = a.core.json
														.merge(
																a.core.dom
																		.position(v.domList.outer),
																a.core.dom
																		.getSize(v.domList.outer)), c = a.core.json
														.merge(
																a.core.dom
																		.position(c),
																a.core.dom
										...
										submit : {
											...
											focus : function(b) {
												b = a.fixEvent(b);
												a.addClassName(b.target,
														"W_btn_g_current")
											},
											blur : function(b) {
												b = a.fixEvent(b);
												a.removeClassName(b.target,
														"W_btn_g_current")
											}
										}
									}, y = {
										...
										capslock : function(b) {
											b = a.fixEvent(b);
											var c = b.keyCode || b.which, d = b.shiftKey
													|| c == 16 || !1;
											(c >= 65 && c <= 90 && !d || c >= 97
													&& c <= 122 && d)
													&& x.errTip.show({
										...
										login : {
											...
											success : function(a) {
												...
												if (a.result) {
													var b;
													$CONFIG.redirect ? b = $CONFIG.redirect
															: a.redirect ? b = a.redirect
																	: a.userinfo
																			&& a.userinfo.userdomain ? b = "http://"
																			+ window.location.hostname
																			+ "/"
																			+ a.userinfo.userdomain
																			: b = "http://"
																					+ window.location.hostname;
										...
										verifycode : {
											...
											disable : function() {
												...
												a.removeEvent(p.verifycode,
														"keydown", y.enter)
											},
											reset : function() {
												r.verifycode_auto
														&& clearTimeout(r.verifycode_auto);
												r.verifycode_auto = setTimeout(
														A.verifycode.reset,
														l.verifyCodeDelay);
												e(p.verifycode_image);
												p.verifycode.value = ""
														+ o.ctls.verifycode.pars.text
											},
											isVisible : function() {
										...
										vsncode : {
											enable : function() {
												...
												A.vsncode.reset();
												a.addEvent(p.vsncode,
														"keydown", y.enter)
											},
											disable : function() {
												p.vsncode_box.style.display = "none";
												o.ctls.vsncode.disabled(1);
												a.removeEvent(p.vsncode,
														"keydown", y.enter)
											},
											reset : function() {
												p.vsncode.value = ""
														+ o.ctls.vsncode.pars.text
											},
											isVisible : function() {
							...
							function(a) {
								return function(b, c) {
									...
									f.setMiddle = function() {
										var b = a.core.util.winSize(), c = e
												.getSize(!0), d = a.core.util
												.scrollPos().top
												+ (b.height - c.h) / 2;
										g.style.top = (d > 0 ? d : 0) + "px";
										g.style.left = (b.width - c.w) / 2
												+ "px";
										return f
									};
							...
							function(a) {
								...
								return function(d, g, h) {
									...
									if (a.core.dom.isNode(d) && c.test(g)) {
										...
										l = a.core.evt.custEvent.define(m,
												"beforeFix");
										m.setAlign(g, h);
										function n(c) {
											c = c || window.event;
											a.core.evt.custEvent.fire(l,
													"beforeFix", c.type);
											k && (!b || i == "c") && f(d, i, j)
										}
										b
												|| a.core.evt.addEvent(window,
														"scroll", n);
										a.core.evt
												.addEvent(window, "resize", n);
										return m
									}
								}
							});
							...
							function(a) {
								return function(b, c) {
									var d, e, f, g, h, i, j, k, l = function() {
										...
										a.custEvent.add(d.actObj, "dragStart",
												o);
										...
										if (d.dragtype === "perch") {
											...
											h.push("width:"
													+ d.moveDom.offsetWidth
													+ "px");
											h.push("height:"
													+ d.moveDom.offsetHeight
													+ "px");
											h.push("left:" + g.l + "px");
											h.push("top:" + g.t + "px");
										...
										var c = g.t + (b.pageY - g.pageY), e = g.l
												+ (b.pageX - g.pageX), h = c
												+ g.height, i = e + g.width, j = g.pageHeight
												- d.pagePadding, k = g.pageWidth
												- d.pagePadding;
										if (h < j && c > 0)
											f.style.top = c + "px";
										else {
									...
									e.destroy = function() {
										...
										a.custEvent.remove(d.actObj,
												"dragStart", o);
										a.custEvent.remove(d.actObj, "dragEnd",
												p);
										a.custEvent.remove(d.actObj, "draging",
												q);
										h.destroy && h.destroy();
										d = null;
										f = null;
								...
								return function(g, h) {
									...
									a.custEvent.add(l, "hide", function() {
										a.custEvent.remove(l, "hide",
												arguments.callee);
										a.removeEvent(k.getDom("OK"), "click",
												n);
										e.setUnused(k);
										clearTimeout(m);
										i.OK()
			...
			STK
					.register(
							"pl.login.connect.source.plugin.connectMSN",
							function(a) {
								return function(b) {
									var c = {}, d = window.App = {}, e = null, f = {
										...
										var b = f, c = $CONFIG.lang === "zh-tw" ? "zh-tw"
												: "zh-cn", d = [
												"client_id=" + b.wrap_client_id,
												"scope="
														+ encodeURIComponent(b.wrap_scope),
												"response_type="
														+ b.response_type,
												"redirect_uri="
														+ encodeURIComponent(b.wrap_callback) ]
												.join("&");
										d = d + (c ? "&locale=" + c : "");
										d = b.url + "?" + d;
			...
			STK.register("pl.login.connect.source.main", function(a) {
				return function(b) {
					...
					function h() {
						e.msn
								&& (d = a.pl.login.connect.source.plugin
										.connectMSN(e.msn))
					}
					function g() {
					...
					function f() {
						if (!a.isNode(b))
							throw "pl.login.connect.source.main need node!!!"
					}
					var c = {}, d, e;
					i();
					c.destroy = function() {
			...
			STK
					.register(
							"pl.login.video.source.main",
							function(a) {
								return function(b, c) {
									if (!!a.core.dom.isNode(b)) {
										var d = a.kit.dom
												.parseDOM(a.builder(b).list), c = a
												.parseParam(
														{
															vid : "",
															mpid : ""
			...
			STK.register("pl.login.video.index", function(a) {
				var b = a.E("pl_login_video"), c = a.pl.login.video.source
						.main(b);
				return c
			});
			STK.pageletM.start()
